//
//  SwiftPackageShowDepsTool.swift
//  ios-mcp
//
...
func registerSwiftPackageShowDepsTool(
    ...
    let manifest = ToolManifest(
        ...
        description: "Show Swift package dependency tree in JSON format. Falls back to session workspace or project parent directory for the package path.",
            ...
            do {
                ...
                if result.succeeded {
                    ...
                    return .error(ToolError(
                        code: .commandFailed,
                        message: "swift package show-dependencies failed.",
                ...
                return .error(ToolError(
                    code: .internalError,
                    message: "Failed to run swift package show-dependencies: \(error.localizedDescription)"
                ))
            }
        }
    }
